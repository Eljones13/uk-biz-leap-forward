...
const bankAccounts: BankAccount[] = [
  {
    ...
    highlights: ["No monthly fees", "24/7 customer support", "FCA protected"],
    rating: 4.8,
  ...
  },
  {
    ...
    highlights: ["Easy expense tracking", "Beautiful app interface", "Quick setup"],
    rating: 4.6,
  ...
  },
  {
    ...
    highlights: ["Established reputation", "Global reach", "In-person support"],
    rating: 4.2,
  ...
  },
  {
    ...
    highlights: ["Free period", "Comprehensive services", "Local branch support"],
    rating: 4.1,
  ...
  },
  {
    ...
    highlights: ["Completely free", "SME focused", "Quick setup"],
    rating: 4.5,
  ...
  },
  {
    ...
    highlights: ["Global payments", "Multiple currencies", "Advanced features"],
    rating: 4.3,
...
export const BankAccountComparison = () => {
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold mb-2">Choose Your Business Bank Account</h2>
        <p className="text-muted-foreground">
          Compare the UK's leading business banking options and find the perfect fit for your company
        </p>
      </div>
        ...
        {bankAccounts.map((account) => (
          <Card key={account.id} className={`relative ${account.recommended ? 'ring-2 ring-primary' : ''}`}>
            ...
            <CardContent className="space-y-4">
              ...
              >
                {account.recommended ? "Apply Now" : "Learn More"}
              </Button>
            </CardContent>
          </Card>
        ))}
